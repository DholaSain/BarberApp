                      ...
                      child: TicketMaterial(
                        ...
                        leftChild: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('Total Services: ' + booking.services!.length.toString(),
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    ...
                                    Text(DateFormat('MMMM d, ' 'yyyy').format(booking.bookingForTime!),
                                        style: kWhiteText.copyWith(fontWeight: FontWeight.bold))
                                  ])),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        Text(DateFormat('h:mm a').format(booking.bookingForTime!),
                                            style: kWhiteText.copyWith(fontWeight: FontWeight.bold))
                                      ],
                                    ),
                                  ),
