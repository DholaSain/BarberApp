...
class ViewAndEditProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController bNameCntrlr =
        TextEditingController(text: usersCtlr.user!.businessName);
    final TextEditingController streetCntrlr =
        TextEditingController(text: usersCtlr.user!.streetAddress);

    final TextEditingController cityCntrlr =
        TextEditingController(text: usersCtlr.user!.city);
    final TextEditingController provinceCntrlr =
        TextEditingController(text: usersCtlr.user!.province);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          usersCtlr.user!.isBarber! ? 'BUSINESS PROFILE' : 'CUSTOMER PROFILE',
          style:
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  UsersModel usersModel = UsersModel(
                    ...
                    streetAddress: streetCntrlr.text,
          ...
          child: Column(
            ...
            children: [
              ...
              DPUpdateWidget(
                ...
                isBarber: usersCtlr.user!.isBarber,
              ),
              const SizedBox(height: 8),
              usersCtlr.user!.isBarber!
              ...
              const SizedBox(height: 20),
              const Text('Business Details', style: kH3),
              SimpleTextField(
                lable: 'Business Name',
                controller: bNameCntrlr,
              ),
              SimpleTextField(
                lable: 'Street Address',
                controller: streetCntrlr,
              ),
              const SizedBox(height: 6),
              Row(
                children: [
          ...
          SizedBox(
            ...
            child: ClipOval(
                child: Obx(() => imageUpdatePath.value != ''
                    ...
                    : imageURL != ''
                        ? NetImage(imagePath: imageURL!)
                        : Image.asset(isBarber ?? false
                            ? 'assets/logo.png'
                            : 'assets/User.png'))),
          ),
          Positioned(
