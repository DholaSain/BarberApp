...
import 'package:barber/Controllers/b_booking_controller.dart';
import 'package:barber/Models/booking_model.dart';
import 'package:barber/Views/Barber/BBookings/b_booking_details.dart';
...
class BBookings extends StatelessWidget {
  BBookings({Key? key}) : super(key: key);

  final BBookingsController bookingsCntrlr = Get.put(BBookingsController());
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: TicketMaterial(
                  ...
                  tapHandler: () {
                    Get.to(() => BBookingDetails(booking: booking));
                  },
